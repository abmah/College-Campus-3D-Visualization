...
class PointerLockControlsCannon extends THREE.EventDispatcher {
  ...
  update(delta) {
    ...
    if (moveForward || moveBackward) velocity.add(frontVector.multiplyScalar(direction.z));
    if (moveLeft || moveRight) velocity.add(sideVector.multiplyScalar(direction.x));
